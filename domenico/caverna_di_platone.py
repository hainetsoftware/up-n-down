...
game_images = {}
framepersecond = 30
pipeimage = 'domenico/images/pipe.png'
background_image = 'domenico/images/background.png'
birdplayer_image = 'domenico/images/domenico-.png'
sealevel_image = 'domenico/images/base.png'
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
		pygame.image.load('domenico/images/0.png').convert_alpha(),
		pygame.image.load('domenico/images/1.png').convert_alpha(),
		pygame.image.load('domenico/images/2.png').convert_alpha(),
		pygame.image.load('domenico/images/3.png').convert_alpha(),
		pygame.image.load('domenico/images/4.png').convert_alpha(),
		pygame.image.load('domenico/images/5.png').convert_alpha(),
		pygame.image.load('domenico/images/6.png').convert_alpha(),
		pygame.image.load('domenico/images/7.png').convert_alpha(),
		pygame.image.load('domenico/images/8.png').convert_alpha(),
		pygame.image.load('domenico/images/9.png').convert_alpha()
	)

...
game_images = {}
framepersecond = 30
pipeimage = 'dif_dario_moccia/images/pipe.png'
background_image = 'dif_dario_moccia/images/background.png'
birdplayer_image = 'dif_dario_moccia/images/dario.png'
sealevel_image = 'dif_dario_moccia/images/base.png'
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
		pygame.image.load('dif_dario_moccia/images/0.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/1.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/2.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/3.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/4.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/5.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/6.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/7.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/8.png').convert_alpha(),
		pygame.image.load('dif_dario_moccia/images/9.png').convert_alpha()
	)

...
game_images = {}
framepersecond = 30
pipeimage = 'classic/images/pipe.png'
background_image = 'classic/images/background.png'
birdplayer_image = 'classic/images/bird.png'
sealevel_image = 'classic/images/base.png'
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
		pygame.image.load('classic/images/0.png').convert_alpha(),
		pygame.image.load('classic/images/1.png').convert_alpha(),
		pygame.image.load('classic/images/2.png').convert_alpha(),
		pygame.image.load('classic/images/3.png').convert_alpha(),
		pygame.image.load('classic/images/4.png').convert_alpha(),
		pygame.image.load('classic/images/5.png').convert_alpha(),
		pygame.image.load('classic/images/6.png').convert_alpha(),
		pygame.image.load('classic/images/7.png').convert_alpha(),
		pygame.image.load('classic/images/8.png').convert_alpha(),
		pygame.image.load('classic/images/9.png').convert_alpha()
	)
	...
	print("Benvenut* in Uccellino! by hai.network")

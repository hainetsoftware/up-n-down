...
game_images = {}
framepersecond = 50
pipeimage = 'dif_normal/images/pipe.png'
background_image = 'dif_normal/images/background.png'
birdplayer_image = 'dif_normal/images/bird.png'
sealevel_image = 'dif_normal/images/base.png'
...
if __name__ == "__main__":
	...
	game_images['scoreimages'] = (
		pygame.image.load('dif_normal/images/0.png').convert_alpha(),
		pygame.image.load('dif_normal/images/1.png').convert_alpha(),
		pygame.image.load('dif_normal/images/2.png').convert_alpha(),
		pygame.image.load('dif_normal/images/3.png').convert_alpha(),
		pygame.image.load('dif_normal/images/4.png').convert_alpha(),
		pygame.image.load('dif_normal/images/5.png').convert_alpha(),
		pygame.image.load('dif_normal/images/6.png').convert_alpha(),
		pygame.image.load('dif_normal/images/7.png').convert_alpha(),
		pygame.image.load('dif_normal/images/8.png').convert_alpha(),
		pygame.image.load('dif_normal/images/9.png').convert_alpha()
	)
